...
def exec_huff(char_freqs):
    C = []      # array of HTreeNodes
    # char_freqs = {'a': 0.45, 'c': 0.12, 'b': 0.13, 'd': 0.16, 'e': 0.09, 'f': 0.05}
    for c in char_freqs.keys():
        # make a node with key=val, char=key
...
#     char_freqs = get_random_freqs()
    ...
    #print "cfs:",char_freqs
    print "code:",code
    #nu = calc_total_bits(char_freqs,code)
