...
k = Knight(4,4)
for p in k:
    test( k.position.distance(p) == jump[0].distance(Point(0,0)) )
...
Circle.pi = math.pi
test( c1.pi == math.pi and c2.pi == math.pi )
c1.pi = 3.14159
test( c1.pi == 3.14159 and c2.pi == math.pi and Circle.pi == math.pi )
#-------------------------------------------------------------------------------
